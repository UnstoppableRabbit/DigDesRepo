...
{ 
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var atr = type.GetMethod("PrivateMethod", BindingFlags.NonPublic | BindingFlags.Instance);
            ...
            // Dictionary<string, int> finishList = (Dictionary<string,int>)atr.Invoke(c, new string[] { s });
             Dictionary<string, int> finishList = c.PublicMethod(s);
 
            using (StreamWriter w = new StreamWriter("C:/Users/ASUS/Desktop/итог1.txt")) {
